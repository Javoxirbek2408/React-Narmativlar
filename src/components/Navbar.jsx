        ...
        <div>
            <nav className='container flex items-center pt-12 justify-between '>
                ...
                <ul className='flex gap-5'>
                    <li>
                        <NavLink to={"/"} className={"font-normal text-base leading-6 tracking-[0%] text-center font-popins hover:underline "}>Home</NavLink>

                    </li>
                    <li>
                        <NavLink to={"/"} className={"font-normal text-base leading-6 tracking-[0%] text-center font-popins hover:underline"}>Contact</NavLink>
                    </li>
                    <li>
                        <NavLink to={"/"} className={"font-normal text-base leading-6 tracking-[0%] text-center font-popins hover:underline"}>About</NavLink>
                    </li>
                    <li>
                        <NavLink to={"/"} className={"font-normal text-base leading-6 tracking-[0%] text-center font-popins hover:underline"}>Sign Up</NavLink>
                    </li>
                </ul>
